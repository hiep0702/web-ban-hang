...
Route::get('/index', [LoginController::class, 'show_index'])->name('admin.index')->middleware('auth.rolesadmin');
...
Route::get('/show-brand', [BrandController::class, 'show_brand'])->middleware('auth.rolesadmin');
...
Route::get('/show-category', [CategoryController::class, 'show_category'])->middleware('auth.rolesadmin');
...
Route::get('/delete-order1/{OrderID}', [OrderController::class,'deleteOrder']);
