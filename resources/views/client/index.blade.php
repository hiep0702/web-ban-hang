        ...
        <div class="carousel-inner">
                ...
                <div class="container">
                    <div class="w3l-space-banner">
                        <div class="carousel-caption p-lg-5 p-sm-4 p-3">
                            <p>Rau
                                <span>100%</span> không hóa chất
                            </p>
                            <h3 class="font-weight-bold pt-2 pb-lg-5 pb-4">Hữu Cơ
                                <span></span>
                ...
                <div class="container">
                    <div class="w3l-space-banner">
                        <div class="carousel-caption p-lg-5 p-sm-4 p-3">
                            ...
                            <h3 class="font-weight-bold pt-2 pb-lg-5 pb-4">Rõ Ràng
                                <span></span>
                            </h3>
                            <a class="button2" href="product.html">Shop Now </a>
                        </div>
            ...
            <div class="carousel-item item4">
                <div class="container">
                    <div class="w3l-space-banner">
                        <div class="carousel-caption p-lg-5 p-sm-4 p-3">
                            <p>Thực phẩm an toàn đến mọi nhà
                                <span></span> 
                            </p>
                            <h3 class="font-weight-bold pt-2 pb-lg-5 pb-4">Nông sản sạch
                                <span></span>
                            </h3>
                            <a class="button2" href="product.html">Shop Now </a>
                        </div>
            ...
            <div class="row">
                ...
                <div class="agileinfo-ads-display col-lg-12">
                    <div class="wrapper">
                        ...
                        <!-- second section -->
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                            <h3 class="heading-tittle text-center font-italic">Rau quả không hóa chất</h3>
                            <div class="row">
                        ...
                        <div class="product-sec1 product-sec2 px-sm-5 px-3">
                            <div class="row">
                                <h3 class="col-md-4 effect-bg">Đảm bảo sức khỏe</h3>
                                <p class="w3l-nut-middle"></p>
                                <div class="col-md-8 bg-right-nut">
                                    <img src="https://mard.gov.vn/PublishingImages/T%C3%A1i%20c%C6%A1%20c%E1%BA%A5u/rau%20c%C3%A1c%20lo%E1%BA%A1i.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <!-- //third section -->
                        ...
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
                            <h3 class="heading-tittle text-center font-italic">Top Sản Phẩm Bán Chạy </h3>
                            <div class="row">
